class Admin::Classes::Sy::ManageController < Admin::LayoutController
    ...
    def update
        ...
        return if is_date_present(update_params[:start], update_params[:end])
        return if is_date_valid(update_params[:start], update_params[:end])
    ...
    def create
      ...
      return if is_date_present(school_year_params[:start], school_year_params[:end])
      return if is_date_valid(school_year_params[:start], school_year_params[:end])
    ...
    def is_date_present(start_date, end_date)
      start_date = start_date.to_date
      end_date = end_date.to_date

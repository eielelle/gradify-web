...
ActiveRecord::Schema[7.1].define(version: 2024_07_17_105916) do
  ...
  create_table "student_accounts", force: :cascade do |t|
    ...
    t.index ["permission_id"], name: "index_student_accounts_on_permission_id"
  ...
  add_foreign_key "student_accounts", "permissions"
end
